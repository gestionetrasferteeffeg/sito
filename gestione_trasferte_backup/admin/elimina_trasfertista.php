...
<head>
	...
	<script type="text/javascript">
  	function elimina(i)
    {
    	 $.get("/mostra_clienti/elimina_trasfertista.php?i="+i, function(data, status){
            if(status=="success")
            	location.reload();
            else
            	alert("error");
...
<div id="wrapper">
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <div style="margin:20px;width:100%;">
      	<h1 style="text-align:center;">Elimina Trasfertista</h1>
        <br/>
        ...
        <table class="table table-striped" style="width:100%;">
          ...
          <?php
              ...
              $query="SELECT * FROM trasfertista WHERE eliminato=0;";
              ...
              else
              {
                   ...
                   for($i=0;$i<sizeof($vettore);$i++)
                   {
                      ?>
                      <tr>
                          <td><div id="nome"><?php echo $vettore[$i][1]; ?></div></td>
                          <td><div id="cognome"><?php echo $vettore[$i][2]; ?></div></td>
                          <td><div id="mail"><?php echo $vettore[$i][3]; ?></div></td>
                          <td><div id="telefono"><?php echo $vettore[$i][5]; ?></div></td>
                          <td><div id="admin"><?php echo $vettore[$i][6]; ?></div></td>
